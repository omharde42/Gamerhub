...
export default function JobsPage() {
  ...
  return (<div className="space-y-6"><div className="flex items-center justify-between"><h1 className="text-2xl font-bold">Jobs</h1><Link href="/jobs/post"><Button variant="gradient" className="gap-2"><Briefcase className="h-4 w-4" />Post a Job</Button></Link></div>

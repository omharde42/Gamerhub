export interface User { id: string; email: string; emailVerified: string | null; role: 'USER' | 'MODERATOR' | 'ADMIN' | 'SUPER_ADMIN'; banned: boolean; createdAt: string; profile: Profile | null; subscription: Subscription | null; }

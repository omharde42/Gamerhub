...
export const GAMES_CONFIG: Record<string, GameConfig> = {
  ...
  pubg: {
    ...
    color: '#F59E0B',
    brandColor: '#F59E0B',
    bgGradient: 'from-amber-950/60 via-zinc-950/40 to-black',
    borderColor: 'border-amber-500/40',
    description: 'Sync PUBG Steam K/D Ratio, Win Rate, Lifetime Kills & Matches',
    fields: [
      {
        name: 'playerName',
        label: 'PUBG Steam In-Game Name',
